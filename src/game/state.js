    ...
    missions: withMissionEconomy(withMissionStatChanges({
      ...
      phone: {
        ...
        openBusiness: {
          ...
          oneTime: true,
          cashCost: 1000,
          popupTitle: "Business Opened",
          popupText: "Your business is now running. The Business tab has been unlocked.",
          popupIcon: "🏪",
          flags: [{ flagName: "hasBusiness", newValue: true }],
          hideFlags: ["hasBusiness"]
        }
      },
      work: {
        workHard: {
